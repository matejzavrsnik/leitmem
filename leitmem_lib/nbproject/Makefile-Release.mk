...
${OBJECTDIR}/time_probe.o: time_probe.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -I../../mzlib/include -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/time_probe.o time_probe.cpp
