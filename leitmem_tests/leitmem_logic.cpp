...
TEST_F(fixture_leitmem_logic, one_question_can_get_next_question) 
{
...
TEST_F(fixture_leitmem_logic, answering_question_incorrectly_will_ask_others_first) 
{
   ...
   std::string_view question1 = engine.get_next_question();
   
   engine.submit_answer("wrong answer");
   
   std::string_view question2 = engine.get_next_question();
...
TEST_F(fixture_leitmem_logic, answering_all_questions_incorrectly_will_start_again) 
{
   ...
   std::string_view question3 = engine.get_next_question();
   
   engine.submit_answer("wrong answer");
   
   std::string_view question4 = engine.get_next_question();
